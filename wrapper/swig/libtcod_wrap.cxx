...
SWIGINTERN float TCODNoise_get(TCODNoise *self,float *f,int n){
        return self->get(f);
    }
SWIGINTERN float TCODNoise_getEx(TCODNoise *self,float *f,int n,TCOD_noise_type_t typ){
        return self->get(f, typ);
    }
SWIGINTERN float TCODNoise_getFbm(TCODNoise *self,float *f,int n,float octaves){
        return self->getFbm(f, octaves);
    }
SWIGINTERN float TCODNoise_getFbmEx(TCODNoise *self,float *f,int n,float octaves,TCOD_noise_type_t typ){
        return self->getFbm(f, octaves, typ);
    }
SWIGINTERN float TCODNoise_getTurbulence(TCODNoise *self,float *f,int n,float octaves){
        return self->getTurbulence(f, octaves);
    }
SWIGINTERN float TCODNoise_getTurbulenceEx(TCODNoise *self,float *f,int n,float octaves,TCOD_noise_type_t typ){
...
static int _wrap_TCODNameGenerator_parse__SWIG_0(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("TCODNameGenerator::parse",1,"char const *");
...
static int _wrap_TCODNameGenerator_generate__SWIG_0(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("TCODNameGenerator::generate",1,"char *");
...
static int _wrap_TCODNameGenerator_generateCustom__SWIG_0(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("TCODNameGenerator::generateCustom",1,"char *");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("TCODNameGenerator::generateCustom",2,"char *");
...
static int _wrap_new_StringVector__SWIG_3(lua_State* L) {
  ...
  if(!lua_isnumber(L,1)) SWIG_fail_arg("std::vector<(p.char)>",1,"unsigned int");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("std::vector<(p.char)>",2,"char *");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative")
  arg1 = (unsigned int)lua_tonumber(L, 1);
  arg2 = (char *)lua_tostring(L, 2);
...
static int _wrap_TCODConsole_initRoot__SWIG_0(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,3)) SWIG_fail_arg("TCODConsole::initRoot",3,"char const *");
...
static int _wrap_TCODConsole_setCustomFont__SWIG_0(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("TCODConsole::setCustomFont",1,"char const *");
...
static int _wrap_TCODConsole_mapStringToFont(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("TCODConsole::mapStringToFont",1,"char const *");
...
static int _wrap_TCODConsole_setWindowTitle(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("TCODConsole::setWindowTitle",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_TCODConsole_print(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,4)) SWIG_fail_arg("print",4,"char const *");
...
static int _wrap_TCODConsole_printEx(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,6)) SWIG_fail_arg("printEx",6,"char const *");
...
static int _wrap_TCODConsole_printRect(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,6)) SWIG_fail_arg("printRect",6,"char const *");
...
static int _wrap_TCODConsole_printRectEx(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,8)) SWIG_fail_arg("printRectEx",8,"char const *");
...
static int _wrap_TCODConsole_getHeightRect(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,6)) SWIG_fail_arg("getHeightRect",6,"char const *");
...
static int _wrap_TCODConsole_printFrame__SWIG_0(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,8)) SWIG_fail_arg("printFrame",8,"char const *");
  if(!SWIG_lua_isnilstring(L,9)) SWIG_fail_arg("printFrame",9,"char *");
  if(!SWIG_lua_isnilstring(L,10)) SWIG_fail_arg("printFrame",10,"char *");
              ...
              if (_v) {
                ...
                if (_v) {
                  ...
                  if (_v) {
                    ...
                    if (_v) {
                      {
                        _v = SWIG_lua_isnilstring(L,argv[9]);
                      }
                      if (_v) {
...
static int _wrap_new_TCODImage__SWIG_1(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("TCODImage",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_TCODImage_save(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("save",2,"char const *");
...
static int _wrap_TCODRandom_dice(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("dice",2,"char const *");
...
static int _wrap_TCODRandom_diceRoll__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("diceRoll",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("diceRoll",1,"TCODRandom *");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("diceRoll",2,"char const *");
...
static int _wrap_TCODNoise_get(lua_State* L) {
  ...
  arg2 = SWIG_get_float_num_array_var(L,2,&arg3);
  if (!arg2) SWIG_fail;
  result = (float)TCODNoise_get(arg1,arg2,arg3);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
...
static int _wrap_TCODNoise_getEx(lua_State* L) {
  int SWIG_arg = 0;
  TCODNoise *arg1 = (TCODNoise *) 0 ;
  float *arg2 = (float *) 0 ;
  int arg3 ;
  ...
  SWIG_check_num_args("getEx",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getEx",1,"TCODNoise *");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("getEx",3,"TCOD_noise_type_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_TCODNoise,0))){
    SWIG_fail_ptr("TCODNoise_getEx",1,SWIGTYPE_p_TCODNoise);
  }
  
  arg2 = SWIG_get_float_num_array_var(L,2,&arg3);
  if (!arg2) SWIG_fail;
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&argp4,SWIGTYPE_p_TCOD_noise_type_t,0))){
    SWIG_fail_ptr("TCODNoise_getEx",4,SWIGTYPE_p_TCOD_noise_type_t);
  }
  arg4 = *argp4;
  
  result = (float)TCODNoise_getEx(arg1,arg2,arg3,arg4);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  SWIG_FREE_ARRAY(arg2);
  return SWIG_arg;
...
static int _wrap_TCODNoise_getFbm(lua_State* L) {
  ...
  result = (float)TCODNoise_getFbm(arg1,arg2,arg3,arg4);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  SWIG_FREE_ARRAY(arg2);
  return SWIG_arg;
...
static int _wrap_TCODNoise_getFbmEx(lua_State* L) {
  int SWIG_arg = 0;
  TCODNoise *arg1 = (TCODNoise *) 0 ;
  float *arg2 = (float *) 0 ;
  int arg3 ;
  ...
  SWIG_check_num_args("getFbmEx",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getFbmEx",1,"TCODNoise *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("getFbmEx",3,"float");
  if(!lua_isuserdata(L,4)) SWIG_fail_arg("getFbmEx",4,"TCOD_noise_type_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_TCODNoise,0))){
    SWIG_fail_ptr("TCODNoise_getFbmEx",1,SWIGTYPE_p_TCODNoise);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&argp5,SWIGTYPE_p_TCOD_noise_type_t,0))){
    SWIG_fail_ptr("TCODNoise_getFbmEx",5,SWIGTYPE_p_TCOD_noise_type_t);
  }
  arg5 = *argp5;
  
  result = (float)TCODNoise_getFbmEx(arg1,arg2,arg3,arg4,arg5);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  SWIG_FREE_ARRAY(arg2);
  return SWIG_arg;
...
static int _wrap_TCODNoise_getTurbulence(lua_State* L) {
  ...
  if (!arg2) SWIG_fail;
  arg4 = (float)lua_tonumber(L, 3);
  result = (float)TCODNoise_getTurbulence(arg1,arg2,arg3,arg4);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  SWIG_FREE_ARRAY(arg2);
  return SWIG_arg;
...
static int _wrap_TCODNoise_getTurbulenceEx(lua_State* L) {
  int SWIG_arg = 0;
  TCODNoise *arg1 = (TCODNoise *) 0 ;
  float *arg2 = (float *) 0 ;
  int arg3 ;
  ...
  SWIG_check_num_args("getTurbulenceEx",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getTurbulenceEx",1,"TCODNoise *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("getTurbulenceEx",3,"float");
  if(!lua_isuserdata(L,4)) SWIG_fail_arg("getTurbulenceEx",4,"TCOD_noise_type_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_TCODNoise,0))){
    SWIG_fail_ptr("TCODNoise_getTurbulenceEx",1,SWIGTYPE_p_TCODNoise);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&argp5,SWIGTYPE_p_TCOD_noise_type_t,0))){
    SWIG_fail_ptr("TCODNoise_getTurbulenceEx",5,SWIGTYPE_p_TCOD_noise_type_t);
  }
  arg5 = *argp5;
  
  result = (float)TCODNoise_getTurbulenceEx(arg1,arg2,arg3,arg4,arg5);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  SWIG_FREE_ARRAY(arg2);
  return SWIG_arg;
...
static swig_lua_method swig_TCODNoise_methods[] = {
    ...
    {"getEx", _wrap_TCODNoise_getEx}, 
    {"getFbm", _wrap_TCODNoise_getFbm}, 
    {"getFbmEx", _wrap_TCODNoise_getFbmEx}, 
    {"getTurbulence", _wrap_TCODNoise_getTurbulence}, 
    {"getTurbulenceEx", _wrap_TCODNoise_getTurbulenceEx}, 
    {0,0}
};
...
static int _wrap_TCODSystem_saveScreenshot(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("TCODSystem::saveScreenshot",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_TCODSystem_fileExists(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("TCODSystem::fileExists",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_TCODSystem_getCurrentResolution(lua_State* L) {
  ...
  SWIG_check_num_args("TCODSystem::getCurrentResolution",2,2)
  arg1 = (int *)1; 
  arg2 = (int *)2; 
...
static int _wrap_TCODSystem_getCharSize(lua_State* L) {
  ...
  SWIG_check_num_args("TCODSystem::getCharSize",2,2)
  arg1 = (int *)1; 
  arg2 = (int *)2; 
...
static int _wrap_TCODText_setProperties(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("setProperties",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("setProperties",3,"int");
  if(!SWIG_lua_isnilstring(L,4)) SWIG_fail_arg("setProperties",4,"char const *");
...
static int _wrap_TCOD_key_t_c_set(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("c",2,"char");
...
static int _wrap_TCODColor_getHSV(lua_State* L) {
  ...
  SWIG_check_num_args("getHSV",4,4)
